...
classdef MatPsi < handle
    ...
    methods
        ...
        function this = MatPsi(varargin)
            ...
            this.objectHandle = MatPsi.MatPsi_mex('new', varargin{:}, this.path);
        end
        ...
        function delete(this)
            if(~isempty(this.objectHandle))
                MatPsi.MatPsi_mex('delete', this.objectHandle);
            end
        end
        ...
        function varargout = molecule_string(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('molecule_string', this.objectHandle, varargin{:});
        end
        
        % string = matpsi.basis_name(); 
        % The basis set name used in constructor  
        function varargout = basis_name(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('basis_name', this.objectHandle, varargin{:});
        end
        
        % matpsi.set_basis(string); 
        % Set basis set 
        function varargout = set_basis(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('set_basis', this.objectHandle, varargin{:});
        end
        ...
        function varargout = set_ncores(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('set_ncores', this.objectHandle, varargin{:});
        end
        ...
        function varargout = set_memory(this, varargin)
            ...
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('set_memory', this.objectHandle, varargin{:});
        end
        ...
        function varargout = fix_mol(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('fix_mol', this.objectHandle, varargin{:});
        end
        
        % matpsi.free_mol(); 
        % Free the molecule so that the program can move/reorient the molecule 
        function varargout = free_mol(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('free_mol', this.objectHandle, varargin{:});
        end
        ...
        function varargout = natom(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('natom', this.objectHandle, varargin{:});
        end
        
        % integer = matpsi.nelec(); 
        % Number of electrons in the molecule 
        function varargout = nelec(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('nelec', this.objectHandle, varargin{:});
        end
        
        % matrix(natom, 3) = matpsi.geom(); 
        % The molecule's geometry in Cartesian coordinates 
        function varargout = geom(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('geom', this.objectHandle, varargin{:});
        end
        ...
        function varargout = basis_has_puream(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('basis_has_puream', this.objectHandle, varargin{:});
        end
        
        % integer = matpsi.nbasis(); 
        % Number of basis functions 
        function varargout = nbasis(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('nbf', this.objectHandle, varargin{:});
        end
        ...
        function varargout = nshell(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('nshell', this.objectHandle, varargin{:});
        end
        
        % vector(nshell) = matpsi.shellTypes(); 
        % shellTypes 
        function varargout = shellTypes(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('shellTypes', this.objectHandle, varargin{:});
        end
        
        % vector(nshell) = matpsi.shellNprims(); 
        % shellNprims 
        function varargout = shellNprims(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('shellNprims', this.objectHandle, varargin{:});
        end
        
        % vector(nshell) = matpsi.shellNfuncs(); 
        % shellNfuncs 
        function varargout = shellNfuncs(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('shellNfuncs', this.objectHandle, varargin{:});
        end
        
        % vector(nshell) = matpsi.shell2center(); 
        % shell2center 
        function varargout = shell2center(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('shell2center', this.objectHandle, varargin{:});
        end
        ...
        function varargout = func2center(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('func2center', this.objectHandle, varargin{:});
        end
        ...
        function varargout = func2am(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('func2am', this.objectHandle, varargin{:});
        end
        
        % vector(nprim) = matpsi.primExps; 
        % primExps 
        function varargout = primExps(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('primExps', this.objectHandle, varargin{:});
        end
        
        % vector(nprim) = matpsi.primCoefs; 
        % primCoefs 
        function varargout = primCoefs(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('primCoefs', this.objectHandle, varargin{:});
        end
        ...
        function varargout = overlap(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('overlap', this.objectHandle, varargin{:});
        end
        ...
        function varargout = kinetic(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('kinetic', this.objectHandle, varargin{:});
        end
        ...
        function varargout = potential(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('potential', this.objectHandle, varargin{:});
        end
        ...
        function varargout = potential_sep(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('potential_sep', this.objectHandle, varargin{:});
        end
        ...
        function varargout = potential_Zxyz(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('potential_Zxyz', this.objectHandle, varargin{:});
        end
        
        % dipole, 3 (nbasis, nbasis) matrix 
        function varargout = dipole(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('dipole', this.objectHandle, varargin{:});
        end
        ...
        function varargout = tei_ijkl(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('tei_ijkl', this.objectHandle, varargin{:});
        end
        ...
        function varargout = tei_uniqN(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('tei_uniqN', this.objectHandle, varargin{:});
        end
        
        % vector(nuniq) = matpsi.tei_alluniq(); 
        % A vector of all unique two-electron integrals 
        function varargout = tei_alluniq(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('tei_alluniq', this.objectHandle, varargin{:});
        end
        ...
        function varargout = tei_allfull(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('tei_allfull', this.objectHandle, varargin{:});
        end
        ...
        function varargout = tei_alluniqJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('tei_alluniqJK', this.objectHandle, varargin{:});
        end
        ...
        function varargout = InitJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('InitJK', this.objectHandle, varargin{:});
        end
        
        % matpsi.UseDirectJK(); 
        % Enable DirectJK object that computes J and K with direct algoritm 
        function varargout = UseDirectJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('UseDirectJK', this.objectHandle, varargin{:});
        end
        ...
        function varargout = UsePKJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('UsePKJK', this.objectHandle, varargin{:});
        end
        ...
        function varargout = UseICJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('UseICJK', this.objectHandle, varargin{:});
        end
        ...
        function varargout = UseMatlabJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('UseMatlabJK', this.objectHandle, varargin{:});
        end
        
        function varargout = SetMatlabJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('SetMatlabJK', this.objectHandle, varargin{:});
        end
        
        function varargout = DisableMatlabJK(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('DisableMatlabJK', this.objectHandle, varargin{:});
        end
        % ### EXPERT ###  
        ...
        function varargout = JKtype(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('JKtype', this.objectHandle, varargin{:});
        end
        ...
        function varargout = Density2J(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('Density2J', this.objectHandle, varargin{:});
        end
        ...
        function varargout = Density2K(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('Density2K', this.objectHandle, varargin{:});
        end
        ...
        function varargout = Density2G(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('Density2G', this.objectHandle, varargin{:});
        end
        ...
        function varargout = OccMO2J(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('OccMO2J', this.objectHandle, varargin{:});
        end
        ...
        function varargout = OccMO2K(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('OccMO2K', this.objectHandle, varargin{:});
        end
        ...
        function varargout = OccMO2G(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('OccMO2G', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_msqc(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_msqc', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_msqc_fromC(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_msqc_fromC', this.objectHandle, varargin{:});
        end
        
        % double = matpsi.RHF(); 
        % Run a Hartree-Fock calculation and returns the final total energy 
        function varargout = RHF(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHFenv(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHFenv', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_fromC(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_fromC', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHFenv_fromC(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHFenv_fromC', this.objectHandle, varargin{:});
        end
        
        % matpsi.RHF_reset(); 
        % Reset the RHF object 
        function varargout = RHF_reset(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_reset', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_EnableMOM(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_EnableMOM', this.objectHandle, varargin{:});
        end
        
        % matpsi.RHF_DisableMOM(); 
        % Disable MOM 
        function varargout = RHF_DisableMOM(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_DisableMOM', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_EnableDamping(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_EnableDamping', this.objectHandle, varargin{:});
        end
        
        % matpsi.RHF_DisableDamping(); 
        % Disable damping 
        function varargout = RHF_DisableDamping(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_DisableDamping', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_EnableDIIS(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_EnableDIIS', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_DisableDIIS(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_DisableDIIS', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_GuessSAD(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_GuessSAD', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_GuessCore(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_GuessCore', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_EHF(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_EHF', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_C(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_C', this.objectHandle, varargin{:});
        end
        ...
        function varargout = RHF_EMO(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_EMO', this.objectHandle, varargin{:});
        end
        
        % vector(nbasis) = matpsi.RHF_D(); 
        % Final density matrix 
        function varargout = RHF_D(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_D', this.objectHandle, varargin{:});
        end
        
        % vector(nbasis) = matpsi.RHF_H(); 
        % Core 1-electron Hamiltonian H1 
        function varargout = RHF_H(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_H', this.objectHandle, varargin{:});
        end
        
        % vector(nbasis) = matpsi.RHF_J();
        % Coulomb matrix J 
        function varargout = RHF_J(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_J', this.objectHandle, varargin{:});
        end
        
        % vector(nbasis) = matpsi.RHF_K(); 
        % Exchange matrix K 
        function varargout = RHF_K(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_K', this.objectHandle, varargin{:});
        end
        
        % vector(nbasis) = matpsi.RHF_F(); 
        % Total Fock matrix F 
        function varargout = RHF_F(this, varargin)
            [varargout{1:nargout}] = MatPsi.MatPsi_mex('RHF_F', this.objectHandle, varargin{:});
        end
    ...
    methods (Static, Access = private)
        ...
        [varargout] = MatPsi_mex(command_name, objectHandle, varargin);
