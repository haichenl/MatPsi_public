...
public:
    UHF(Process::Environment& process_environment_in, Options& options, boost::shared_ptr<PSIO> psio, boost::shared_ptr<Chkpt> chkpt);
    UHF(Process::Environment& process_environment_in, Options& options, boost::shared_ptr<PSIO> psio);
    virtual ~UHF();
